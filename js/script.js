...
function displayCount(studentConuted) {
  document.querySelector("#counterBar #totalCount").textContent = studentConuted.total;
  document.querySelector("#counterBar #gryffindorCount").textContent = studentConuted.Gryffindor;
  document.querySelector("#counterBar #hufflepuffCount").textContent = studentConuted.Hufflepuff;
  document.querySelector("#counterBar #ravenclawCount").textContent = studentConuted.Ravenclaw;
  document.querySelector("#counterBar #slytherinCount").textContent = studentConuted.Slytherin;
  document.querySelector("#counterBar #expelledCount").textContent = studentConuted.expelled;
  document.querySelector("#counterBar #displayingCount").textContent = studentConuted.displaying;
}
